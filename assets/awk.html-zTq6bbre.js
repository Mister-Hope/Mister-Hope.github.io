import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as c,o as p,c as i,d as s,a as e,e as a,b as t}from"./app-TnzoJgBu.js";const l={},d=s("h1",{id:"awk",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#awk"},[s("span",null,"awk")])],-1),r={href:"https://en.wikipedia.org/wiki/AWK",target:"_blank",rel:"noopener noreferrer"},k=s("code",null,"awk",-1),u=t(`<p>它依次处理文件的每一行，并读取里面的每一个字段。对于日志、CSV 那样的每行格式相同的文本文件，<code>awk</code> 可能是最方便的工具。</p><figure><img src="https://www.wangbase.com/blogimg/asset/201811/bg2018110702.jpg" alt="Book" tabindex="0" loading="lazy"><figcaption>Book</figcaption></figure><p><code>awk</code> 其实不仅仅是工具软件，还是一种编程语言。不过，这里只介绍它的命令行用法，对于大多数场合，应该足够用了。</p><h2 id="基本用法" tabindex="-1"><a class="header-anchor" href="#基本用法"><span>基本用法</span></a></h2><p><code>awk</code> 的基本用法就是下面的形式。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 格式</span>
...
SYS
SYNC
</code></pre></div><p>上面代码中，第一个字段输出时都变成了大写。</p><p>其他常用函数如下。</p><blockquote><ul><li><code>tolower()</code>: 字符转为小写。</li><li><code>length()</code>: 返回字符串长度。</li><li><code>substr()</code>: 返回子字符串。</li><li><code>sin()</code>: 正弦。</li><li><code>cos()</code>: 余弦。</li><li><code>sqrt()</code>: 平方根。</li><li><code>rand()</code>: 随机数。</li></ul></blockquote>`,36),h=s("code",null,"awk",-1),g={href:"https://www.gnu.org/software/gawk/manual/html_node/Built_002din.html#Built_002din",target:"_blank",rel:"noopener noreferrer"},b=t(`<h2 id="条件" tabindex="-1"><a class="header-anchor" href="#条件"><span>条件</span></a></h2><p><code>awk</code> 允许指定输出条件，只输出符合条件的行。</p><p>输出条件要写在动作的前面。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">awk</span> <span class="token string">&#39;条件 动作&#39;</span> 文件名
...
sys
<span class="token function">sync</span>
</code></pre></div><h2 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接"><span>参考链接</span></a></h2>`,18),m={href:"https://gregable.com/2010/09/why-you-should-know-just-little-awk.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://likegeeks.com/awk-command/",target:"_blank",rel:"noopener noreferrer"};function f(w,x){const n=c("ExternalLinkIcon");return p(),i("div",null,[d,s("p",null,[s("a",r,[k,e(n)]),a("是处理文本文件的一个应用程序，几乎所有 Linux 系统都自带这个程序。")]),u,s("p",null,[h,a(" 内置函数的完整列表，可以查看"),s("a",g,[a("手册"),e(n)]),a("。")]),b,s("ul",null,[s("li",null,[s("a",m,[a("An Awk tutorial by Example"),e(n)]),a(", Greg Grothaus")]),s("li",null,[s("a",v,[a("30 Examples for Awk Command in Text Processing"),e(n)]),a(", Mokhtar Ebrahim")])])])}const y=o(l,[["render",f],["__file","awk.html.vue"]]);export{y as default};
