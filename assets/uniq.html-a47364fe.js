import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,f as s}from"./app-dc1aa647.js";const c={},t=s(`<h1 id="uniq" tabindex="-1"><a class="header-anchor" href="#uniq" aria-hidden="true">#</a> uniq</h1><p><code>uniq</code> 用于过滤掉重复的行，该命令只对排序后的文件有效。</p><p>下面是 <code>example.txt</code> 文件的内容。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>a
a
b
a
b
...
</code></pre></div>`,9),o=[t];function p(r,d){return n(),e("div",null,o)}const u=a(c,[["render",p],["__file","uniq.html.vue"]]);export{u as default};
