import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as n,b as e}from"./app-5b4b8186.js";const o={},t=e(`<h1 id="export" tabindex="-1"><a class="header-anchor" href="#export" aria-hidden="true">#</a> export</h1><p><code>export</code> 命令用于向子 Shell 输出变量。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">export</span> <span class="token assign-left variable">hotellogs</span><span class="token operator">=</span><span class="token string">&quot;/workspace/hotel-api/storage/logs&quot;</span>
...
/usr/bin/zsh
</code></pre></div>`,10),p=[t];function l(c,r){return s(),n("div",null,p)}const h=a(o,[["render",l],["__file","export.html.vue"]]);export{h as default};
