import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,d as s}from"./app-4e4d2326.js";const t={},c=s(`<h1 id="file" tabindex="-1"><a class="header-anchor" href="#file" aria-hidden="true">#</a> file</h1><p><code>file</code> 命令用来某个文件的类型。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">file</span> index.html
...
</code></pre></div>`,5),o=[c];function i(l,p){return n(),a("div",null,o)}const u=e(t,[["render",i],["__file","file.html.vue"]]);export{u as default};
