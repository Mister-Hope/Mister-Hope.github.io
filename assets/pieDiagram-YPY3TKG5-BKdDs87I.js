import{t as e}from"./chunk-AQ6EADP3-CZhslHi-.js";import{W as t,c as n,p as r,q as i}from"./chunk-LIEV3EAG-pyKGssV3.js";import{$ as a,A as o,K as s,R as c,T as l,U as u,Y as d,j as f,rt as p,z as m}from"./chunk-2AEHWXPW-C2JLZMcN.js";import{t as h}from"./chunk-6BELYETK-BQiOn7H_.js";import{t as g}from"./chunk-JQRUD6KW-Dbva2Z17.js";import{j as _}from"./chunk-NV3KIAZN-BbJqBeNg.js";import"./chunk-STOV2HOB-GnExfzIX.js";import{a as v,p as y}from"./chunk-7CWYLC5S-DuKKeujX.js";var b=m.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,a()},`clear`),setDiagramTitle:o,getDiagramTitle:f,setAccTitle:u,getAccTitle:l,setAccDescription:c,getAccDescription:s,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),i.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{g(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let t=await _(`pie`,e);i.debug(t),E(t,T)},`parse`)},O=e(e=>`
  .pieCircle{
