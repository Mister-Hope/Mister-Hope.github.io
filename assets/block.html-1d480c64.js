...
</code></pre></div><details class="custom-container details"><summary>渲染结果</summary><blockquote><p>This is a blockquote with two paragraphs. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam hendrerit mi posuere lectus. Vestibulum enim wisi, viverra nec, fringilla in, laoreet vitae, risus.</p><p>Donec sit amet nisl. Aliquam semper ipsum sit amet velit. Suspendisse id sem consectetuer libero luctus adipiscing.</p></blockquote></details><div class="custom-container info"><p class="custom-container-title">易写性</p><p>处于易写性的考虑，Markdown 允许您只在整个段落的第一行最前面加上 <code>&gt;</code> :</p><details class="custom-container details"><summary>例子</summary><p><strong>输入</strong>:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token blockquote punctuation">&gt;</span> This is a blockquote with two paragraphs. Lorem ipsum dolor sit amet,
  consectetuer adipiscing elit. Aliquam hendrerit mi posuere lectus.
  Vestibulum enim wisi, viverra nec, fringilla in, laoreet vitae, risus.

<span class="token blockquote punctuation">&gt;</span> Donec sit amet nisl. Aliquam semper ipsum sit amet velit. Suspendisse
  id sem consectetuer libero luctus adipiscing.
</code></pre></div><p><strong>输出</strong>:</p><!-- markdownlint-disable MD028 --><blockquote><p>This is a blockquote with two paragraphs. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam hendrerit mi posuere lectus. Vestibulum enim wisi, viverra nec, fringilla in, laoreet vitae, risus.</p></blockquote><blockquote><p>Donec sit amet nisl. Aliquam semper ipsum sit amet velit. Suspendisse id sem consectetuer libero luctus adipiscing.</p></blockquote><!-- markdownlint-enable MD028 --></details><p>但是请注意，我们<strong>不推荐</strong>使用这种做法，这并不是符合 Markdown 最佳实践。</p><p>同时，<code>&gt;</code> 后面的空格也是可选的，我们也推荐您加上它。</p></div><details class="custom-container details"><summary>块引言可以有阶层 (例如: 引言内的引言) ，只要根据层数加上不同数量的 &gt;</summary><p><strong>输入</strong>:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token blockquote punctuation">&gt;</span> This is the first level of quoting.
<span class="token blockquote punctuation">&gt;</span>
...
</code></pre></div><p><strong>输出</strong>:</p><blockquote><p>This is the first level of quoting.</p><blockquote><p>This is nested blockquote.</p></blockquote><p>Back to the first level.</p></blockquote></details><details class="custom-container details"><summary>引言的块内也可以使用其他的 Markdown 语法，包括标题、列表、代码块等</summary><p><strong>输入</strong>:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token blockquote punctuation">&gt;</span> <span class="token list punctuation">1.</span> This is the first list item.
...
</code></pre></div><details class="custom-container details"><summary>渲染结果</summary><ul><li>Red</li><li>Green</li><li>Blue</li></ul></details><div class="custom-container info"><p class="custom-container-title">其他支持的符号</p><p>Markdown 最初的规范也支持使用星号、加号:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">+</span> Red
<span class="token list punctuation">+</span> Green
<span class="token list punctuation">+</span> Blue
...
</code></pre></div><details class="custom-container details"><summary>渲染结果</summary><ol><li>Bird</li><li>McHale</li><li>Parish</li></ol></details><p>很重要的一点是，您在列表标记上使用的数字并不会影响输出的 HTML 结果，因为上面的列表所产生的 HTML 标记为:</p><div class="language-html" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>ol</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div><details class="custom-container details"><summary>这意味着您无需刻意对列表进行标号</summary><p>如果您使用:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">1.</span> Bird
<span class="token list punctuation">1.</span> McHale
<span class="token list punctuation">1.</span> Parish
</code></pre></div><p>列表项也会正确的渲染:</p><ol><li>Bird</li><li>McHale</li><li>Parish</li></ol></details><div class="custom-container info"><p class="custom-container-title">将标号交给 Markdown</p><p>人工为列表进行正确的标号与全部使用 <code>1.</code> 都符合 Markdown 最佳实践。</p><p>但是请不要错误的进行标号，如:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">2.</span> Bird
...
</code></pre></div><details class="custom-container details"><summary>渲染结果</summary><ul><li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam hendrerit mi posuere lectus. Vestibulum enim wisi, viverra nec, fringilla in, laoreet vitae, risus.</li><li>Donec sit amet nisl. Aliquam semper ipsum sit amet velit. Suspendisse id sem consectetuer libero luctus adipiscing.</li></ul></details><div class="custom-container info"><p class="custom-container-title">易写性</p><p>处于易写性的考虑，列表缩进不是强制的，也就是以下的内容渲染结果与上面相同。</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">-</span> Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
Aliquam hendrerit mi posuere lectus. Vestibulum enim wisi,
viverra nec, fringilla in, laoreet vitae, risus.
<span class="token list punctuation">-</span> Donec sit amet nisl. Aliquam semper ipsum sit amet velit.
Suspendisse id sem consectetuer libero luctus adipiscing.
</code></pre></div><details class="custom-container details"><summary>渲染结果</summary><ul><li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam hendrerit mi posuere lectus. Vestibulum enim wisi, viverra nec, fringilla in, laoreet vitae, risus.</li><li>Donec sit amet nisl. Aliquam semper ipsum sit amet velit. Suspendisse id sem consectetuer libero luctus adipiscing.</li></ul></details><p>但是我们<strong>不推荐</strong>这种写法，这种写法会导致 Markdown 源文件可读性变差，不符合 Markdown 最佳实践。</p></div><p>如果列表项目间用空行分开， Markdown 会把项目的内容在输出时用 <code>&lt;p&gt;</code> 标签包起来，举例来说:</p><details class="custom-container details"><summary>普通的无序列表</summary><p>输入:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">-</span> Bird
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>ul</span><span class="token punctuation">&gt;</span></span>
</code></pre></div><details class="custom-container details"><summary>渲染结果</summary><ul><li><p>Bird</p></li><li><p>Magic</p></li><li><p>Wood</p></li></ul></details><p>这会在列表项之间创建更大的空间。</p><div class="custom-container tip"><p class="custom-container-title">最佳实践</p><p>对于一个列表项来说，只要有一项使用了空行，所有项目都会转换为段落，也就是以下格式也会渲染为段落列表。</p><details class="custom-container details"><summary>例子</summary><p><strong>输入</strong>:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">-</span> Bird
<span class="token list punctuation">-</span> Magic

<span class="token list punctuation">-</span> Wood
</code></pre></div><p><strong>输出</strong>:</p><ul><li><p>Bird</p></li><li><p>Magic</p></li><li><p>Wood</p></li></ul></details><p>Markdown 最佳实践要求您在每一个列表间始终(或始终不)添加空行。</p></div><p>列表项目可以包含多个段落，每个项目下的段落都必须缩进 2 - 4 个空白或是一个 tab。</p><details class="custom-container details"><summary>例子</summary><p><strong>输入</strong>:</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">-</span> This is a list item with two paragraphs.
...
</code></pre></div><p>在代码块里面， <code>&amp;</code> 、 <code>&lt;</code> 和 <code>&gt;</code> 会自动转成 HTML 实体，这样的方式让您非常容易使用 Markdown 插入范例用的 HTML 原始码，只需要复制粘贴，再加上缩进就可以了，剩下的 Markdown 都会帮您处理。</p><details class="custom-container details"><summary>Markdown 处理例子</summary><p><strong>输入</strong>:</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token code"><span class="token punctuation">\`\`\`</span><span class="token code-language">html</span>
...
</code></pre></div><p>一个代码块会一直持续到没有缩进的那一行 (或是文件结尾)。 <a href="#footnote-ref2" class="footnote-backref">↩︎</a></p></li></ol></section>`,86),o=[p];function i(l,c){return s(),n("div",null,o)}const d=a(e,[["render",i],["__file","block.html.vue"]]);export{d as default};
