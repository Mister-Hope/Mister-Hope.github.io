import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as n,f as e}from"./app-3f200a18.js";const l={},i=e(`<h1 id="硬件操作" tabindex="-1"><a class="header-anchor" href="#硬件操作" aria-hidden="true">#</a> 硬件操作</h1><h2 id="df" tabindex="-1"><a class="header-anchor" href="#df" aria-hidden="true">#</a> df</h2><p><code>df</code> 命令查看硬盘信息。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">df</span>
...
</code></pre></div>`,71),o=[i];function c(t,p){return a(),n("div",null,o)}const u=s(l,[["render",c],["__file","hardware.html.vue"]]);export{u as default};
