...
sys
<span class="token function">sync</span>
</code></pre></div><h2 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接" aria-hidden="true">#</a> 参考链接</h2>`,18),m={href:"https://gregable.com/2010/09/why-you-should-know-just-little-awk.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://likegeeks.com/awk-command/",target:"_blank",rel:"noopener noreferrer"};function f(w,x){const a=c("ExternalLinkIcon");return p(),i("div",null,[l,s("p",null,[s("a",r,[u,e(a)]),n("是处理文本文件的一个应用程序，几乎所有 Linux 系统都自带这个程序。")]),k,s("p",null,[h,n(" 内置函数的完整列表，可以查看"),s("a",g,[n("手册"),e(a)]),n("。")]),b,s("ul",null,[s("li",null,[s("a",m,[n("An Awk tutorial by Example"),e(a)]),n(", Greg Grothaus")]),s("li",null,[s("a",v,[n("30 Examples for Awk Command in Text Processing"),e(a)]),n(", Mokhtar Ebrahim")])])])}const y=t(d,[["render",f],["__file","awk.html.vue"]]);export{y as default};
