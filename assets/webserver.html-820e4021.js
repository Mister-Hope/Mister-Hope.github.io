...
</code></pre></div><div class="custom-container tip"><p class="custom-container-title">提示</p><p>如果报了 permission limitted 的错误，说明 php 没法访问 html 文件夹，修改配置的 html 文件夹权限即可。</p></div>`,24),c=[t];function i(l,o){return n(),s("div",null,c)}const r=a(p,[["render",i],["__file","webserver.html.vue"]]);export{r as default};
