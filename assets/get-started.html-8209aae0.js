...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),I=n("code",null,"icon",-1),R={href:"https://github.com/Hope-Studio/innenu-res/blob/main/res/icon/",target:"_blank",rel:"noopener noreferrer"},Y=n("code",null,"icon",-1),D=n("code",null,".svg",-1),F=t(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> 账号
<span class="token key atrule">content</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> list
    <span class="token key atrule">header</span><span class="token punctuation">:</span> 了解更多
    <span class="token key atrule">items</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> list
   ...
   └─ guide
       └─ account
          ...
          ├─ authorize.yml (统一身份认证)
          └─ index.yml (账号主页)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>比如，对于所有文件来说，他们都可以通过 <code>/guide/account/mail/intro</code> 访问 <code>intro.yml</code>。</p></div><p>至此，您应该能够独自完成大部分的页面编辑工作了。</p>`,6);function G(T,U){const e=i("ExternalLinkIcon"),l=i("RouterLink");return o(),d("div",null,[k,u(" more "),v,n("details",m,[y,g,h,b,n("ol",null,[n("li",null,[a("访问 "),n("a",x,[a("https://authserver.nenu.edu.cn/authserver/login"),s(e)])]),_,f,j]),E,B,n("ol",null,[n("li",null,[a("访问 "),n("a",S,[a("https://authserver.nenu.edu.cn/authserver/login"),s(e)])]),q]),L,N]),n("p",null,[a("接下来您就需要按照 "),s(l,{to:"/note/innenu/tag-list.html"},{default:c(()=>[a("参数表")]),_:1}),a(" 进行页面的创建。")]),$,w,z,n("p",null,[a("按照 "),s(l,{to:"/note/innenu/tag-list.html#%E6%80%BB%E4%BD%93%E7%BB%93%E6%9E%84"},{default:c(()=>[a("参数表 → 总体结构")]),_:1}),a(" 完成页面的基础信息添加。页面的标题可以起为“统一身份认证”，假定当天是 2021 年 11 月 1 日，您叫张三。")]),C,n("p",null,[a("如 "),s(l,{to:"/note/innenu/tag-list.html#%E6%94%AF%E6%8C%81%E7%9A%84%E7%BB%84%E4%BB%B6"},{default:c(()=>[a("参数表 → 支持的组件")]),_:1}),a(" 所说:")]),H,n("p",null,[a("接下来，我们需要参阅 "),s(l,{to:"/note/innenu/tag-list.html#title"},{default:c(()=>[a("参数表 → title 参数")]),_:1}),a("，设置更多参数描述组件。")]),V,n("div",O,[A,n("p",null,[a("关于完整的服务器文件结构，请访问 "),n("a",M,[a("https://github.com/Hope-Studio/innenu-res"),s(e)])])]),X,n("p",null,[a("我们可以添加额外的 "),I,a(" 属性来设置一个美观的图标。当前可用的全部图标请详见 "),n("a",R,[a("https://github.com/Hope-Studio/innenu-res/blob/main/res/icon/"),s(e)]),a("。 我们可以直接找到相应图标并设置 "),Y,a(" 为文件名 (不带 "),D,a(" 后缀)。")]),F])}const K=p(r,[["render",G],["__file","get-started.html.vue"]]);export{K as default};
