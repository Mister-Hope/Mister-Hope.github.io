import{ac as e,F as a,G as n,ae as s}from"./framework-293293bc.js";const t={},c=s(`<h1 id="file" tabindex="-1"><a class="header-anchor" href="#file" aria-hidden="true">#</a> file</h1><p><code>file</code> 命令用来某个文件的类型。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">file</span> index.html
...
</code></pre></div>`,5),i=[c];function l(o,p){return a(),n("div",null,i)}const u=e(t,[["render",l],["__file","file.html.vue"]]);export{u as default};
