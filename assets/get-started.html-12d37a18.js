import{ac as p,M as o,N as d,U as u,L as n,$ as s,W as a,ad as c,ae as t,a1 as i}from"./framework-6fc096bd.js";const r={},k=n("p",null,"本部分将手把手引领您完成一个页面的制作，其中会涉及最常见的组件。",-1),v=t('<h2 id="材料准备" tabindex="-1"><a class="header-anchor" href="#材料准备" aria-hidden="true">#</a> 材料准备</h2><p>假定您已经获得以下材料:</p><ul><li>统一身份认证登陆 <img src="https://mp.innenu.com/img/account/authserver.jpg" alt="统一身份认证登陆"></li><li>修改密码页面截图 <img src="https://mp.innenu.com/img/account/reset-password.jpg" alt="修改密码页面截图"></li><li>别名管理页面截图 <img src="https://mp.innenu.com/img/account/email-address.jpg" alt="别名管理页面截图"></li></ul>',3),m={class:"custom-container details"},y=n("summary",null,"相关材料",-1),g=n("p",null,[s("一、"),n("strong",null,"获得学号")],-1),h=n("p",null,"学号是 10 位数字，您收到的录取通知书编号和日后发放的校园卡 💳 卡号即是学号。",-1),b=n("p",null,[s("二、"),n("strong",null,"获得邮箱(别名)")],-1),x={href:"https://authserver.nenu.edu.cn/authserver/login",target:"_blank",rel:"noopener noreferrer"},_=n("li",null,"使用学号与默认密码进行登录。",-1),f=n("li",null,"登陆后，您可以在“别名管理中”中通过别名获得自己的邮箱号 ✉",-1),j=n("li",null,"邮箱地址统一为 “别名” + “@nenu.edu.cn”",-1),B=n("p",null,"默认密码: Nenu + 身份证后六位，X 用 1 代替",-1),E=n("p",null,"修改密码及密保绑定",-1),S={href:"https://authserver.nenu.edu.cn/authserver/login",target:"_blank",rel:"noopener noreferrer"},$=n("li",null,"点击“修改密码”，修改初始密码。",-1),q=n("p",null,"提示",-1),L=n("ul",null,[n("li",null,"为了您找回密码时的便捷，建议您在个人资料处绑定其他邮箱或绑定手机，便于密码遗忘后自助找回。"),n("li",null,"由于身份证号可能被他人获得，为了您的资金、消费以及课程成绩安全 🔐，⚠ 请您务必更换默认密码 🔑。")],-1),N=n("h2",{id:"创建页面配置文件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#创建页面配置文件","aria-hidden":"true"},"#"),s(" 创建页面配置文件")],-1),w=n("p",null,[s("打开 VSCode 并选择“文件”-“新建文件”，并立即保存文件为 "),n("code",null,"authorize.yml"),s("。")],-1),z=n("h2",{id:"编写总体结构",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#编写总体结构","aria-hidden":"true"},"#"),s(" 编写总体结构")],-1),C=t(`<details class="custom-container details"><summary>总体结构</summary><table><thead><tr><th>参数</th><th style="text-align:center;">必填</th><th style="text-align:center;">值类型</th><th>内容</th><th>备注</th></tr></thead><tbody><tr><td>title</td><td style="text-align:center;">是</td><td style="text-align:center;"><code>string</code></td><td>导航栏标题</td><td>一般不超过八个字，六字及以下为佳</td></tr><tr><td>desc</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>string</code></td><td>页面描述</td><td>会显示在页脚</td></tr><tr><td>author</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>string</code></td><td>页面的作者</td><td>会显示在页脚</td></tr><tr><td>time</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>string</code></td><td>页面更新时间</td><td>会显示在页脚</td></tr><tr><td>grey</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>boolean</code></td><td>使用灰色背景</td><td>默认为白色背景</td></tr><tr><td>cite</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>string | string[]</code></td><td>页面引用链接</td><td></td></tr><tr><td>content</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>ComponentConfig[]</code></td><td>页面的内容</td><td>数组的每个对象会最终渲染为一个组件</td></tr><tr><td>from</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>string</code></td><td>左上角返回按钮文字</td><td>设置左上角文字，默认为上一级页面标题</td></tr><tr><td>outdated</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>boolean</code></td><td>是否已过时</td><td>可展示一条“页面过时”提示</td></tr><tr><td>shareable</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>boolean</code></td><td>是否可被分享</td><td>是否可以使用小程序的界面分享，默认为 <code>false</code></td></tr><tr><td>contact</td><td style="text-align:center;">否</td><td style="text-align:center;"><code>boolean</code></td><td>“联系开发者”按钮</td><td>是否在分享菜单中显示“联系开发者”，默认为 <code>true</code></td></tr></tbody></table></details><p>参照上述说明，你可以很轻松的编写如下内容:</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> 统一身份认证
...
</code></pre></div><p>在这里，<code>content</code> 暂时被设置成了空数组，它表示页面的内容，接下来我们就需要丰富和完善它。</p><h2 id="添加第一个组件——标题" tabindex="-1"><a class="header-anchor" href="#添加第一个组件——标题" aria-hidden="true">#</a> 添加第一个组件——标题</h2>`,5),H=t(`<blockquote><p><code>content</code> 的每个元素都为一个对象，该对象会最终渲染为一个组件。</p><p>每个配置对象有一个固定的键 <code>tag</code> 来决定渲染的组件。有效的 <code>tag</code> 值及对应的渲染结果如下:</p><ul><li><a href="#title">title</a>: 大标题</li><li>...</li></ul></blockquote><p>现在，我们需要为小程序页面添加第一个组件——标题。</p><p>为让小程序渲染它，我们需要为 content 数组添加第一个元素。为了让这个元素渲染为标题组件，我们需要设置元素为一个对象，并设置 <code>tag</code> 键的值为 <code>title</code>:</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> 统一身份认证
<span class="token key atrule">author</span><span class="token punctuation">:</span> 张三
<span class="token key atrule">date</span><span class="token punctuation">:</span> 2021年11月1日
<span class="token key atrule">shareable</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
...
</code></pre></div>`,4),V=t(`<details class="custom-container details"><summary>title 参数</summary><table><thead><tr><th>参数</th><th style="text-align:center;">必填</th><th style="text-align:center;">值类型</th><th>内容</th></tr></thead><tbody><tr><td>text</td><td style="text-align:center;">是</td><td style="text-align:center;"><code>string</code></td><td>大标题文字</td></tr></tbody></table></details><p>可以看到，我们需要使用 <code>text</code> 来设置标题组件的文字:</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> 统一身份认证
<span class="token key atrule">author</span><span class="token punctuation">:</span> 张三
<span class="token key atrule">date</span><span class="token punctuation">:</span> 2021年11月1日
<span class="token key atrule">shareable</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
<span class="token key atrule">content</span><span class="token punctuation">:</span>
...
<span class="token key atrule">content</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> text
    <span class="token key atrule">text</span><span class="token punctuation">:</span> 学号是 10 位数字，您收到的录取通知书编号和日后发放的校园卡 💳 卡号即是学号。
...
<span class="token key atrule">content</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> text
    <span class="token key atrule">text</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> 学号是 10 位数字，您收到的录取通知书编号和日后发放的校园卡 💳 卡号即是学号。
      <span class="token punctuation">-</span> 这里的文字另起了新行<span class="token punctuation">...</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="文本排版" tabindex="-1"><a class="header-anchor" href="#文本排版" aria-hidden="true">#</a> 文本排版</h2><p>对于同样的排版，您可以有多种方式来实现。假定我们想实现以下文字:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>春眠不觉晓
处处闻啼鸟
</code></pre></div><p>借用文字组件，以下写法的显示并无不同:</p><ul><li><p>使用数组创建多个段落</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> text
  <span class="token key atrule">text</span><span class="token punctuation">:</span>
    <span class="token punctuation">-</span> 春眠不觉晓
    <span class="token punctuation">-</span> 处处闻啼鸟
</code></pre></div></li><li><p>使用多行字符串</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> text
  <span class="token key atrule">text</span><span class="token punctuation">:</span> <span class="token punctuation">|</span><span class="token punctuation">-</span>
    春眠不觉晓
    处处闻啼鸟
</code></pre></div><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> text
  <span class="token key atrule">text</span><span class="token punctuation">:</span>
    <span class="token punctuation">-</span> <span class="token punctuation">|</span><span class="token punctuation">-</span>
      春眠不觉晓
      处处闻啼鸟
</code></pre></div></li><li><p>使用换行符</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> text
...
</code></pre></div></li></ul><p>所以您完全可以根据自己的习惯去进行编辑，不过 Mr.Hope 还是推荐前两种，因为他们更为直观。</p><h2 id="媒体文件存放" tabindex="-1"><a class="header-anchor" href="#媒体文件存放" aria-hidden="true">#</a> 媒体文件存放</h2><p>由于 YAML 是纯文本文件，所有的图片、文件等需单独列出，并在对应的配置项处填入对应的网址。</p><p>in 东师服务器文件结构如下:</p><ul><li>文件: 存放在 <code>https://mp.innenu.com/file/</code>，可以用 <code>$file</code> 索引</li><li>图片: 存放在 <code>https://mp.innenu.com/img/</code>，可以用 <code>$img</code> 索引</li><li>页面 YAML: 存放在 <code>https://mp.innenu.com/res/</code></li><li>图标: 存放在 <code>https://mp.innenu.com/res/icon/</code></li></ul>`,21),M={class:"custom-container info"},O=n("p",{class:"custom-container-title"},"相关信息",-1),A={href:"https://github.com/Hope-Studio/innenu-res",target:"_blank",rel:"noopener noreferrer"},I=t(`<p>对于本页面，您可以获得的图片按照内容进行命名:</p><ul><li>统一身份认证登陆: <code>authserver.jpg</code></li><li>修改密码页面截图: <code>reset-password.jpg</code></li><li>别名管理页面截图: <code>email-address.jpg</code></li></ul><p>同时，您需要在对应的配置项填入:</p><ul><li><code>$img/account/authserver.jpg</code></li><li><code>$img/account/reset-password.jpg</code></li><li><code>$img/account/email-address.jpg</code></li></ul><p>提交时，直接提交下列压缩包结构。</p><div class="language-text" data-ext="text"><pre class="language-text"><code>├─ img
|  └─ account
|     ├─ authserver.jpg
|     ├─ reset-passwor.jpg
|     └─ email-address.jpg
...
<span class="token key atrule">content</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> ul
    <span class="token key atrule">text</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> 登陆后，您可以在“别名管理中”中通过别名获得自己的邮箱号✉
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),R=n("code",null,"icon",-1),X={href:"https://github.com/Hope-Studio/innenu-res/blob/main/res/icon/",target:"_blank",rel:"noopener noreferrer"},Y=n("code",null,"icon",-1),D=n("code",null,".svg",-1),F=t(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> 账号
<span class="token key atrule">content</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> list
    <span class="token key atrule">header</span><span class="token punctuation">:</span> 了解更多
    <span class="token key atrule">items</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时，小程序就可以渲染出正确的列表项，并在您点击“邮箱介绍”时跳转到新页面渲染 <code>intro.yml</code> 文件。</p><div class="custom-container tip"><p class="custom-container-title">回退上一层和从根目录访问</p><p>有些时候，您可能需要从 <code>intro.yml</code> 跳转到 <code>index.yml</code> 中去，这就涉及到表示父目录的方式。我们使用 <code>../</code> 表示父目录，所以对于 <code>intro.yml</code> 来说，<code>index.yml</code> 的路径可写为 <code>../index</code>，而参数表中提到 <code>index</code> 为默认文件，所以可以简写为 <code>../</code>。</p><p>有些时候您能想从根目录开始描述路径，这种情况下，请以 <code>/</code> 开头设置 path，此时您会从 <code>res/</code> 文件夹下开始进行路径的匹配。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>└─ res
   ├─ intro
   |   ...
   └─ guide
       └─ account
          ...
          ├─ authorize.yml (统一身份认证)
          └─ index.yml (账号主页)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>比如，对于所有文件来说，他们都可以通过 <code>/guide/account/mail/intro</code> 访问 <code>intro.yml</code>。</p></div><p>至此，您应该能够独自完成大部分的页面编辑工作了。</p>`,6);function T(U,W){const e=i("ExternalLinkIcon"),l=i("RouterLink");return o(),d("div",null,[k,u(" more "),v,n("details",m,[y,g,h,b,n("ol",null,[n("li",null,[s("访问 "),n("a",x,[s("https://authserver.nenu.edu.cn/authserver/login"),a(e)])]),_,f,j]),B,E,n("ol",null,[n("li",null,[s("访问 "),n("a",S,[s("https://authserver.nenu.edu.cn/authserver/login"),a(e)])]),$]),q,L]),n("p",null,[s("接下来您就需要按照 "),a(l,{to:"/note/innenu/tag-list.html"},{default:c(()=>[s("参数表")]),_:1}),s(" 进行页面的创建。")]),N,w,z,n("p",null,[s("按照 "),a(l,{to:"/note/innenu/tag-list.html#%E6%80%BB%E4%BD%93%E7%BB%93%E6%9E%84"},{default:c(()=>[s("参数表 → 总体结构")]),_:1}),s(" 完成页面的基础信息添加。页面的标题可以起为“统一身份认证”，假定当天是 2021 年 11 月 1 日，您叫张三。")]),C,n("p",null,[s("如 "),a(l,{to:"/note/innenu/tag-list.html#%E6%94%AF%E6%8C%81%E7%9A%84%E7%BB%84%E4%BB%B6"},{default:c(()=>[s("参数表 → 支持的组件")]),_:1}),s(" 所说:")]),H,n("p",null,[s("接下来，我们需要参阅 "),a(l,{to:"/note/innenu/tag-list.html#title"},{default:c(()=>[s("参数表 → title 参数")]),_:1}),s("，设置更多参数描述组件。")]),V,n("div",M,[O,n("p",null,[s("关于完整的服务器文件结构，请访问 "),n("a",A,[s("https://github.com/Hope-Studio/innenu-res"),a(e)])])]),I,n("p",null,[s("我们可以添加额外的 "),R,s(" 属性来设置一个美观的图标。当前可用的全部图标请详见 "),n("a",X,[s("https://github.com/Hope-Studio/innenu-res/blob/main/res/icon/"),a(e)]),s("。 我们可以直接找到相应图标并设置 "),Y,s(" 为文件名 (不带 "),D,s(" 后缀)。")]),F])}const J=p(r,[["render",T],["__file","get-started.html.vue"]]);export{J as default};
