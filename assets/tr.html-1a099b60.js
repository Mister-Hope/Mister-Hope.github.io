import{ac as a,G as s,H as e,ae as n}from"./framework-931f0218.js";const t={},o=n(`<h1 id="tr" tabindex="-1"><a class="header-anchor" href="#tr" aria-hidden="true">#</a> tr</h1><p><code>tr</code> 命令用于按照给定模式转换文本。</p><p>下面是 <code>example.txt</code> 文件的内容。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>Hello World Foo Bar Baz<span class="token operator">!</span>
...
</code></pre></div>`,8),c=[o];function p(r,l){return s(),e("div",null,c)}const i=a(t,[["render",p],["__file","tr.html.vue"]]);export{i as default};
