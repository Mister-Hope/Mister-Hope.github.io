...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),F=n("code",null,"icon",-1),I={href:"https://github.com/Hope-Studio/innenu-res/blob/main/res/icon/",target:"_blank",rel:"noopener noreferrer"},X=n("code",null,"icon",-1),Y=n("code",null,".svg",-1),D=t(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> 账号
<span class="token key atrule">content</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> list
    <span class="token key atrule">header</span><span class="token punctuation">:</span> 了解更多
    <span class="token key atrule">items</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">tag</span><span class="token punctuation">:</span> list
   ...
   └─ guide
       └─ account
          ...
          ├─ authorize.yml (统一身份认证)
          └─ index.yml (账号主页)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>比如，对于所有文件来说，他们都可以通过 <code>/guide/account/mail/intro</code> 访问 <code>intro.yml</code>。</p></div><p>至此，您应该能够独自完成大部分的页面编辑工作了。</p>`,6);function G(K,T){const e=i("ExternalLinkIcon"),l=i("RouterLink");return o(),d("div",null,[k,u(" more "),v,n("details",m,[y,g,h,b,n("ol",null,[n("li",null,[s("访问 "),n("a",x,[s("https://authserver.nenu.edu.cn/authserver/login"),a(e)])]),_,f,j]),E,B,n("ol",null,[n("li",null,[s("访问 "),n("a",S,[s("https://authserver.nenu.edu.cn/authserver/login"),a(e)])]),q]),$,w]),n("p",null,[s("接下来您就需要按照 "),a(l,{to:"/note/innenu/tag-list.html"},{default:c(()=>[s("参数表")]),_:1}),s(" 进行页面的创建。")]),z,C,L,n("p",null,[s("按照 "),a(l,{to:"/note/innenu/tag-list.html#%E6%80%BB%E4%BD%93%E7%BB%93%E6%9E%84"},{default:c(()=>[s("参数表 → 总体结构")]),_:1}),s(" 完成页面的基础信息添加。页面的标题可以起为“统一身份认证”，假定当天是 2021 年 11 月 1 日，您叫张三。")]),N,n("p",null,[s("如 "),a(l,{to:"/note/innenu/tag-list.html#%E6%94%AF%E6%8C%81%E7%9A%84%E7%BB%84%E4%BB%B6"},{default:c(()=>[s("参数表 → 支持的组件")]),_:1}),s(" 所说:")]),H,n("p",null,[s("接下来，我们需要参阅 "),a(l,{to:"/note/innenu/tag-list.html#title"},{default:c(()=>[s("参数表 → title 参数")]),_:1}),s("，设置更多参数描述组件。")]),V,n("div",M,[O,n("p",null,[s("关于完整的服务器文件结构，请访问 "),n("a",A,[s("https://github.com/Hope-Studio/innenu-res"),a(e)])])]),R,n("p",null,[s("我们可以添加额外的 "),F,s(" 属性来设置一个美观的图标。当前可用的全部图标请详见 "),n("a",I,[s("https://github.com/Hope-Studio/innenu-res/blob/main/res/icon/"),a(e)]),s("。 我们可以直接找到相应图标并设置 "),X,s(" 为文件名 (不带 "),Y,s(" 后缀)。")]),D])}const J=p(r,[["render",G],["__file","get-started.html.vue"]]);export{J as default};
