import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,b as e}from"./app-TnzoJgBu.js";const t={},o=e(`<h1 id="tr" tabindex="-1"><a class="header-anchor" href="#tr"><span>tr</span></a></h1><p><code>tr</code> 命令用于按照给定模式转换文本。</p><p>下面是 <code>example.txt</code> 文件的内容。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>Hello World Foo Bar Baz<span class="token operator">!</span>
