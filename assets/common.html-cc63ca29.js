...
<span class="token punctuation">}</span>
</code></pre></div><div class="custom-container tip"><p class="custom-container-title">提示</p><p><code>padding</code> 与 <code>margin</code> 在格式上完全相同。</p></div><h2 id="背景色" tabindex="-1"><a class="header-anchor" href="#背景色" aria-hidden="true">#</a> 背景色</h2><p>使用 <code>background-color</code> 或 <code>background-image</code> 属性进行设置。</p><p>案例:</p><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token selector">.red</span> <span class="token punctuation">{</span>
