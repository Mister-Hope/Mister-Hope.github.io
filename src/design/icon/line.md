...
在常见的图标类型里，如通知、设置、用户和分享之类的图标，对于任何手机用户来说都没有认知和选择压力。但表意准确麻烦的地方在于，一些非常规的寓意，极难用图标表现出来，这才是我们使用线性图标的首要麻烦。
...
几何图形的视觉差，是对于线性图标来说最重要的细节，在《从零开始画图标系列: 超全面的基础知识》图标一致性中已经提及，它也是平面基础理论中不可忽视的内容，这个理论要解决一个核心的问题，即怎么让不同的图形看上去一样大？
...
其实，针对图标的规范，新人第一个想到的应该就是参考线了，也就是所谓的栅格模板。之所以放后面讲解，是因为线性图标的栅格规范，是根据几何的视觉差特性衍生出来的，而不像后面会提到的应用图标由官方提供出来。

我们先简单看看，常见的线性图标栅格是什么样的。
