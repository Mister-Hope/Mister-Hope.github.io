...
<p>
  By default we span 100% of the width of our parent element, and we are as tall as our child
...
<p>
  ...
  will <span>wrap onto a new line if possible (like this one containing text)</span>, or just go on
  to a new line if not, much like this image will do:
